...
public class StepDefination extends Utils {
    ...
    public void update_Place_Payload_with_Address() throws IOException {
    // Write code here that turns the phrase above into concrete actions
    res = given().spec(requestSpecification()).body(data.updatePlacePayload(place_id, "Changed Address"));
    }
